...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('thumbnail', 180, 180, true); // Thumbnail
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('bootstrap-tab', get_template_directory_uri() . '/js/lib/bootstrap/tab.js', array('jquery'), '3.3.7');
...
{
    wp_register_style('html5blank', get_template_directory_uri() . '/static/css/main.css', array(), '1.0.10', 'all');
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        'name' => __('Sidebar Widget Top', 'html5blank'),
    ...
    register_sidebar(array(
        'name' => __('Sidebar Widget Bottom', 'html5blank'),
    ...
    register_sidebar(array(
        ...
        'description' => __('Sidebar for Media Template pages.', 'html5blank'),
        'id' => 'sidebar-widget-media',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
